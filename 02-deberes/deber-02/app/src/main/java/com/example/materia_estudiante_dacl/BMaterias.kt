...
class BMaterias : AppCompatActivity() {
    ...
    //DEFINICIÓN INTENT
    val callbackEditarMateria=registerForActivityResult(
            ...
            if(result.resultCode == Activity.RESULT_OK){
                if(result.data != null){
                    ...
                    mostrarSnackbar(
                        "Materia ${materiaModificada.nombre} Modificado"
                    )
                }
            }
        }
    ...
    private fun crearMateria(
        ...
        val materiaNueva = BMateriasEntity(6, "Historia", "Lorem ipsum dolor sit amet, consectetur adipiscing elit. Mauris tortor nibh, congue vitae mauris et.")
    ...
    override fun onContextItemSelected(item: MenuItem): Boolean {
        return when (item.itemId){
            R.id.id_mi_editar_materia->{
                ...
                callbackEditarMateria.launch(intentEditar)
    ...
    private fun abrirDialogo(index:Int,
        ...
        builder.setPositiveButton(
            ...
            DialogInterface.OnClickListener{
                ...
                materias.removeAt(index)
                adapter.notifyDataSetChanged()
                mostrarSnackbar("Materia Eliminada")
            }
        )
